...
import { getLineItemColumnPercents } from "./document-layout-columns";
import { DOCUMENT_LAYOUT_CSS } from "./document-layout-css";
import {
  escapeHtml,
  formatCurrency,
  formatDate,
...
export class DocumentLayoutRendererService {
  ...
  private estimateLineItemsRowHeights(
    ...
    const columnPercents = getLineItemColumnPercents(box, context);
