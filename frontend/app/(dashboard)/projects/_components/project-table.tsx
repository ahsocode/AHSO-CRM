...
const PRIORITY_CONFIG = {
  ...
  NORMAL: { label: "Chuẩn", variant: "info" as const },
      ...
      <Card className="border border-white/70">
        ...
        <CardContent className="space-y-4">
          {Array.from({ length: 6 }).map((_, index) => (
            <div key={index} className="grid gap-3 rounded-xl border border-border/60 p-4 lg:grid-cols-[1.25fr_1fr_210px_180px]">
      ...
      <Card className="border border-white/70">
        ...
        <CardContent>
          <EmptyState
            ...
            description="Nới bộ lọc hiện tại hoặc thêm dữ liệu mới ở phase tiếp theo để tiếp tục kiểm tra luồng pipeline."
          />
        </CardContent>
      </Card>
    );
