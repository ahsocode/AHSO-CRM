...
export function MobileBottomNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-border/80 bg-white/96 px-2 py-2 shadow-[0_-10px_30px_rgba(21,67,96,0.12)] backdrop-blur-xl print:hidden md:hidden">
